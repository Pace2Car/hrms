        ...
        <div class="row wrapper border-bottom white-bg page-heading">
            <div class="col-lg-10">
                ...
                <ol class="breadcrumb">
                    ...
                    <li>
                        <a href="javascript:void(0)">职位调动</a>
                    </li>
                </ol>
            </div>
            <div class="col-lg-2">
                                ...
                                <table class="table table-striped table-bordered table-hover dataTables-example dataTable" id="DataTables_Table_0" aria-describedby="DataTables_Table_0_info" role="grid">
                                    ...
                                    <c:forEach var="emp" items="${employees}">
                                        <tr id="tr_${emp.empNo}" class="gradeA odd" role="row">
                                            ...
                                            <td>${emp.empName}</td>
                                            <td>
                                                <c:if test="${emp.posName != null}">${emp.posName}</c:if>
                                                <c:if test="${empty emp.posName}">-空缺-</c:if>
                                            </td>
                                            <td class="center">
                                                <a href="#" empNo="${emp.empNo}" onclick="toUpdate(this)"
                                                   class="btn btn-info btn-sm" data-toggle="modal"
                                                   data-target="#updateModal" data-backdrop="static">
                                                    <span class="glyphicon glyphicon-refresh"></span> 更改职位</a>
                                            </td>
                                        </tr>
                                    </c:forEach>
                                    </tbody>
...
<script>
    ...
    function toUpdate(e) {
        ...
        $.get("position/searchEmpPosition?empNo=" + empNo, function (html) {
