        ...
        <div class="row wrapper border-bottom white-bg page-heading">
            <div class="col-lg-10">
                ...
                <ol class="breadcrumb">
                    ...
                    <li>
                        <a href="javascript:void(0)">薪资调整</a>
                    </li>
                </ol>
            </div>
            <div class="col-lg-2">
                            ...
                            <div class="table-responsive">
                                <table class="table table-striped table-bordered table-hover dataTables-example dataTable" id="DataTables_Table_0" aria-describedby="DataTables_Table_0_info" role="grid">
                                    ...
                                    <tr role="row">
                                        ...
                                        <th class="sorting" tabindex="0" aria-controls="DataTables_Table_0" rowspan="1" colspan="1" aria-label="基础工资: activate to sort column ascending" style="width: 417px;">基础工资</th>
                                            ...
                                            <td class="center">
                                                <a href="#" empNo="${emp.empNo}" onclick="toUpdate(this)"
                                                   ...
                                                   data-target="#updateModal" data-backdrop="static">
                                                    <span class="glyphicon glyphicon-refresh"></span> 调整薪资</a>
                                            </td>
                                        </tr>
                                    </c:forEach>
                                    </tbody>
                                    ...
                                    <tr>
                                        ...
                                        <th rowspan="1" colspan="1">基础工资</th>
...
<script>
    ...
    function toUpdate(e) {
        ...
        $.get("salary/searchEmpSalary?empNo=" + empNo, function (html) {
