        ...
        <div class="row wrapper border-bottom white-bg page-heading">
            <div class="col-lg-10">
                ...
                <ol class="breadcrumb">
                    ...
                    <li>
                        <a href="javascript:void(0)">职位设置</a>
                    </li>
                </ol>
            </div>
            <div class="col-lg-2">
                        ...
                        <div class="ibox-content">
                                ...
                                <div class="col-sm-2">
                                    <a href="#" onclick="toInsert()"
                                       ...
                                       data-target="#insertModal" data-backdrop="static">
                                        <span class="fa fa-plus"></span> 新增职位</a>
                                    <br/><br/>
                                </div>
                            </div>
                            <div class="table-responsive">
                                <table class="table table-striped table-bordered table-hover dataTables-example dataTable" id="DataTables_Table_0" aria-describedby="DataTables_Table_0_info" role="grid">
                                    <thead>
                                        <tr role="row">
                                            <th class="sorting_asc" tabindex="0" aria-controls="DataTables_Table_0" rowspan="1" colspan="1" aria-label="职位编号: activate to sort column descending" style="width: 238px;" aria-sort="ascending">职位编号</th>
                                            <th class="sorting" tabindex="0" aria-controls="DataTables_Table_0" rowspan="1" colspan="1" aria-label="职位名称: activate to sort column ascending" style="width: 417px;">职位名称</th>
                                    ...
                                    <tbody>
                                        <c:forEach var="pos" items="${positions}">
                                            <tr id="tr_${pos.id}" class="gradeA odd" role="row">
                                                <td class="sorting_1">${pos.id}</td>
                                                <td>${pos.posName}</td>
                                                <td><fmt:formatDate value="${pos.createTime}" pattern="yyyy-MM-dd HH:mm:ss"/></td>
                                                <td class="center">
                                                    <a href="#" posId="${pos.id}" onclick="toUpdate(this)"
                                                       class="btn btn-info btn-sm" data-toggle="modal"
                                                       data-target="#updateModal" data-backdrop="static">
                                                        <span class="glyphicon glyphicon-refresh"></span> 更新</a>
                                                    <a href="#" posId="${pos.id}" onclick="toDelete(this)"
                                    ...
                                    <tfoot>
                                        <tr>
                                            <th rowspan="1" colspan="1">职位编号</th>
                    ...
                    <div class="form-inline">
                        <div class="form-group">
                            <div class="input-group input-group-md">
                                ...
                                <input style="width: 300px" type="text" class="form-control" id="posName"
                                       name="posName" placeholder="请输入职位名">
                            </div>
                        </div>
                    </div>
                </form>
    ...
    <div class="modal-dialog modal-sm">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                您确定要删除编号为：<span id="posMsg"></span> 的职位吗？
            </div>
            <div class="modal-footer">
                <button type="button" class="btn btn-default" data-dismiss="modal">关闭</button>
...
<script>
    ...
    function toUpdate(e) {
        ...
        var posId = $(e).attr('posId');
        console.dirxml(posId);
        $.get("position/getPositionList?id=" + posId, function (html) {
    ...
    function toDelete(e) {
        ...
        $("#deleteConfirmBtn").click(function () {
            $.get("position/deletePosition?id=" + posId, function (json) {
                if (json.actionFlag) {
                    $("#tr_" + posId).remove();
    ...
    function toInsert() {
        $("#insertBtn").click(function () {
            console.dirxml($("#posName").val());
            var position = $("#insertForm").serialize();
            $.get("position/insertPosition", position, function (json) {
                if (json.actionFlag) {
                    $('#successAlert').slideDown();
                    setTimeout("$('#successAlert').fadeOut()", 3000);
                } else {
                ...
                setTimeout("location.replace('position/getPositionList')", 100);
                return false;
            }, "json");
        });
    }
